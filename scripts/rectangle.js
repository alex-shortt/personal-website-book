...
function initModal() {
  ...
  _modalUnits.push($(".modal-content").modalUnits({angle: 45, distPerc: 1, image: "assets/saturn.png", link: "projects-awge", text: "AWGE"}));
  _modalUnits.push($(".modal-content").modalUnits({angle: 10, distPerc: 0.8, image: "assets/jupiter.png", link: "projects-revenge", text: "Revenge X Storm"}));
  _modalUnits.push($(".modal-content").modalUnits({angle: 38, distPerc: 0.7, image: "assets/moon.png", link: "projects-sounddown", text: "Sound Down"}));
  _modalUnits.push($(".modal-content").modalUnits({angle: 80, distPerc: 1, image: "assets/jupiter.png", link: "projects-nessly", text: "Nessly"}));
  _modalUnits.push($(".modal-content").modalUnits({angle: 69, distPerc: 0.54, image: "assets/saturn.png", link: "projects-portal", text: "GTAV Portal Gun Mod"}));
